...
namespace RevitStartup.Base
{
    ...
    internal sealed partial class BundleManager
    {
        ...
        public (bool updateRequired, string downloadUrl) RequirePlugInUpdate(Uri latestJsonUrl)
        {
            ...
            var (currentVersion, _) = ReadCurrentPluginVersion();
        ...
        /// </summary>
        public (string? version, string? checkUrl) ReadCurrentPluginVersion()
        {
            ...
            return (settings != null ? settings.Version : null,
                    settings != null ? settings.CheckUrl : null);
        }
